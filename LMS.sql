...
degree varchar(30), hired_city varchar(30), hired_date date, mobile_number varchar(30), permanent_pincode int, hired_lab varchar(30), attitude varchar(30), communication_remark varchar(30), 
...
create table candidate_bank_details(id int not null primary key auto_increment ,candidate_id int, name varchar(30) , account_number varchar(30), 
  ...
  final_year_per tinyint, is_final_year_per_verified bool, training_institute varchar(30), 
...
create table lab_threshold(id int not null primary key auto_increment, lab_id int, lab_capacity int, lead_threshold int,
 ...
 foreign key(maker_program_id) references maker_program(id), foreign key(lead_id) references mentor(id), foreign key(ideation_engg_id) references mentor(id),
